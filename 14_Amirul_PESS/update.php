...
if ($btnUpdateClicked == true) {
	...
	{
		echo "<script> window.location.href = 'search.php?message=success&carID=$carId&newStatusId=2'; alert('Patrol car $carId status has been updated to Arrived');</script>";
	}
	...
	{
		echo "<script> window.location.href = 'search.php?message=success&carID=$carId&newStatusId=4'; alert('Patrol car $carId status has been updated to Patrol');</script>";
	}
}
?>
		...
		<section style="margin-top: 20px">
			<form action="update.php" method="POST">
				...
				if ($car != null) {
					...
					echo ' <label for="patrolCarId" class="col-sm-4col-form-label">Car Number </label>';
					...
					echo '</div>';
					echo '<div class="form-group row">';
					echo ' <label for="carNo" class="col-sm-4col-form-label">Patrol Car Status</label>';
					echo ' <div class="col-sm-8">';
